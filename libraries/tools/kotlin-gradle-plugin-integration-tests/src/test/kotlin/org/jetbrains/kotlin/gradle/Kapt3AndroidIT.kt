...
class Kapt3Android70IT : Kapt3AndroidIT() {
    ...
    @Ignore
    override fun testRealm() = super.testRealm()

    @Ignore
    override fun testDatabinding() = super.testDatabinding()

    @Ignore
    override fun testDagger() = super.testDagger()

    @Ignore
    override fun testButterKnife() = super.testButterKnife()
}
